...
const socials = [
  { icon: FaLinkedin, href: 'https://linkedin.com/company/klaxonford', label: 'LinkedIn' },
  { icon: FaFacebook, href: 'https://facebook.com/klaxonford', label: 'Facebook' },
  { icon: FaInstagram, href: 'https://instagram.com/klaxonford', label: 'Instagram' },
]
